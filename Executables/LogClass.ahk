...
{ ; Class that handles writing to a log file
	...
	__New(aLogBaseFilename, aMaxNumbOldLogs=0, aMaxSizeMBLogFile=-1, aLogDir="Logs", aLogExten="")
	{
		; Input variables
	...
	moveLog(aNewLogFilename="", aNewLogDir="Logs", overwriteExistingFile=true)
	...
	;	externalIPAddr := this.URLDownloadToVar(url)
		...
		infoStr  =	
			...
			External IP: N/A   %externalIPAddr%%lesserTab%(at %formattedTime%)
			IP Address #1: N/A
			IP Address #2: N/A
			IP Address #3: N/A
			IP Address #4: N/A
