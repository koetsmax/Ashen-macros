...
IfMsgBox, Yes
{
    ...
    Send, ^a{Backspace}
    Sleep, 100
    Send,{Raw} %gtcbeforeid%{Space}
    Sleep, 100
    Send,{Raw} <@%userID%>{Space}
    Sleep, 100
    Send,{Raw} %gtcafterid%{Space}
    Sleep, 100
    Send,{Raw} %xboxGT%{Space}
    Sleep, 100
    Send,{Raw} %gtcaftergt%
    Sleep, 100
    Send, {enter}
...
IfMsgBox, No
{
    ...
    Send, ^a{Backspace}
    Sleep, 100
    Send,{Raw} %notgtcbeforeid%{Space}
    Sleep, 100
    Send,{Raw} <@%userID%>{Space}
    Sleep, 100
    Send,{Raw} %notgtcafterid%{Space}
    Sleep, 100
    Send,{Raw} %xboxGT%{Space}
    Sleep, 100
    Send,{Raw} %notgtcaftergt%{Space}
    Sleep, 100
    Send,{Raw} %Reason%{Space}
    Sleep, 100
